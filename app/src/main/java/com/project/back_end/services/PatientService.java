...
public class PatientService {
    ...
    public ResponseEntity<Map<String, Object>> getPatientAppointment(Long id, String token) {
        ...
        try {
            ...
            List<AppointmentDTO> appointmentDTOList = appointments.stream()
                    ...
                    .toList();
            response.put("appointments", appointmentDTOList);
    ...
    public ResponseEntity<Map<String, Object>> filterByDoctorAndCondition(String condition, String name, long patiendId) {
        Map<String, Object> response=new HashMap<>();
        ...
        try {
            ...
            List<Appointment> appointments = appointmentRepository.findByDoctorNameAndPatientIdAndStatus(name, patiendId, status);
            List<AppointmentDTO> appointmentDTOList = appointments.stream()
                    .map(a -> new AppointmentDTO(
                            a.getId(),
                            a.getDoctor().getId(),
    ...
    public ResponseEntity<Map<String, Object>> getPatientDetails(String token) {
        ...
        Optional<Patient> patientOptional=patientRepository.findByEmail(email);
        if(patientOptional.isEmpty()){
            response.put("message","No such patient");
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(response);
        }
        else {
            response.put("patient",patientOptional.get());
            return ResponseEntity.ok(response);
        }
    }
